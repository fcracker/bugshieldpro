...
class umPage{
	...
	function get_content() {
		...
		////////////////////////////////////////////////////////////////
		$this->blocks["header"] = $data["HeaderContext"];
		$this->blocks["footer"] = $data["FooterContext"];
		$this->blocks["waitingimg"] = $data["WatingImg"] ? $data["WatingImg"] : "../../images/wait.gif";
		$this->blocks["css"] ='body { float: left; width: 100%; background-color: #fff; height: 100%; background-image:url(../templates/images/' . $data["Body_BgImg"] . ');}
				#wrapper { width: ' . $data["WrapperWidth"] .';  background-color: #' . $data["WrapperBgcolor"] .'}
				#mainmenu { background-color: #' . $data["Menu_BgColor"] .'}
				#mainmenu ul { background-color: #' . $data["Menu_BgColor"] .'}
