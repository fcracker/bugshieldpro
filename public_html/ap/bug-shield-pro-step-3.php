...
function compute(quantity) {
	...
	var product_shipping = <?php echo $cfg['shipping_price_ap']; ?>;
...
<body>
	...
	<div class="section text-center" id="block-section11">
		...
		<div class="step-container">
			...
			<div style="background:#FFF; width:100%; padding-top:5px; padding-bottom:20px; margin-bottom:20px;">
        	<h4 class="limitime text-center" style="font-size:25px">LIMITED TIME SPECIAL OFFER EXPIRES IN </h4>
		...
		<div class="content-col-6">
			<div class="prd-order">
				...
				<table>
					...
					<tr>
						...
						<td>
                            ...
                            <div class="content-half chbot"><strong>$<span id="sub_total"><?php echo $cfg['product_price_pick_'.$postID]; ?></span></strong><br/><strong>$<?php echo $cfg['shipping_price_ap']; ?></strong></div></td>
					</tr>
					<tr>
						<td colspan="3">Total:</td>
						<td>$<span id="total_amount"><?php echo $cfg['product_price_pick_'.$postID] + $cfg['shipping_price_ap']; ?></span></td>
					</tr>
				</table>
				</div>
				...
				<div style="background:url(../assets/images/bugshieldpro-moneyback-step3.png); background-repeat:no-repeat; width:520px; height:555px; margin:120px auto 0;" class="moneybackguarantee">
...
associated bank account. There is no commitment and no minimum to buy.</p>
		...
		<div class="content-col-4">
			...
			<div class="ordr-form ordr-cc-form">
				...
				<form action='../payment.php?path=ap' method="POST">
                	
                    <input type="hidden" id="qty" name="quantity" value="1">
                    <input type="hidden" id="qprice" name="price" value="<?php echo $cfg['product_price_pick_'.$postID] + $cfg['shipping_price_ap']; ?>">
