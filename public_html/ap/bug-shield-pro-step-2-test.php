...
<body>
	...
	<div class="section text-center" id="block-section9">
        ...
        <div class="ordr-form ordr-form-styled" style="display:none;">
            ...
            <input type="submit" name="submit" value="SUBMIT" id="submit" style="background:#ff9900; border:#d0cbbd solid 3px; -webkit-border-radius:10px; -moz-border-radius:10px; border-radius:10px; color:#FFF; font-size:18px; font-weight:bold; padding:5px 25px">
            </form>
        </div>
		...
		<div class="kt-ct">
			<ul class="kit-list">
                ...
                <li>
                    <a href="#" id="pick-1" class="pick-kit">
                        <div class="kit-pick">
                            ...
                            <p class="kit-pick-pric">$99.96 <span class="saveat">SAVE 12%</span></p>
				...
				<div class="kit-pick">
					...
					<p class="kit-pick-pric">$69.94 <span class="saveat">SAVE 8%</span></p>
                ...
                <a href="#" id="pick-2" class="pick-kit">
                    <div class="kit-pick">
                        ...
                        <p class="kit-pick-pric">$119.94  <span class="saveat">SAVE 49%</span></p>
                ...
                <a href="#" id="pick-4" class="pick-kit">
                    <div class="kit-pick">
                        ...
                        <p class="kit-pick-pric">$105.89</p>
