				...
				<div class="trio-kit">
					...
					<div class="laun-kit">
							...
							<div class="inner-laun-kit">
                                ...
                                <form id="form1" action="../add_offer.php?offer=1&amp;laundrykit=1&amp;pid=1&amp;path=bp" method="POST">
					...
					<div class="laun-kit">
							...
							<div class="inner-laun-kit">
								...
								<form id="form2" action="../add_offer.php?offer=1&amp;laundrykit=1&amp;pid=2&amp;path=bp" method="POST">
                                    <input type="hidden" name="quantity" value="1"> 
					...
					<div class="laun-kit">
							...
							<div class="inner-laun-kit">
								...
								<form id="form3" action="../add_offer.php?offer=1&amp;laundrykit=1&amp;pid=3&amp;path=bp" method="POST">
                                    <input type="hidden" name="quantity" value="1"> 
